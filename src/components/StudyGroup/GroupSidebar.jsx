          ...
          {currentGroup.members?.length > 0 ? (
            <div className="space-y-2.5 max-h-48 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-gray-300 dark:scrollbar-thumb-gray-600 scrollbar-track-transparent">
              {currentGroup.members.slice(0, 5).map((member) => (
                <div
                  key={member._id}
                  className="flex items-center p-2 round-sm hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors"
                >
              ...
              {currentGroup.members.length > 5 && (
                <button
                  ...
                  className="flex items-center w-full text-sm text-primary hover:text-primary-dark dark:text-primary-light dark:hover:text-primary-lighter mt-1 p-2 round-sm hover:bg-gray-50 dark:hover:bg-gray-700/40 transition-colors justify-between"
                >
            ...
            <div className="bg-gray-50/80 dark:bg-gray-700/30 rounded-sm p-3 border border-gray-200/70 dark:border-gray-600/40 text-center">
        ...
        <div className="pt-4 border-t border-gray-200 dark:border-gray-700/40">
          ...
          <div className="space-y-1">
            <button
              ...
              className="w-full text-left px-3 py-2 text-sm round-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/40 transition-colors flex items-center"
            >
              <CheckCircle
                size={16}
