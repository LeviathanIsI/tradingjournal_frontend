      ...
      <div className="p-4 sm:p-6">
        <div className="bg-white/90 dark:bg-gray-800/80 rounded-sm border border-gray-200 dark:border-gray-700/60 shadow-md overflow-hidden">
          <div className="p-6 text-center">
            <div className="bg-red-50 dark:bg-red-900/10 p-6 round-sm border border-red-100 dark:border-red-800/30 inline-block">
              ...
              <button
                ...
                className="px-4 py-2 bg-red-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-600 text-white round-sm shadow transition-colors"
              >
  ...
  if (!currentGroup) {
    return (
      <div className="p-4 sm:p-6">
        <div className="bg-white/90 dark:bg-gray-800/80 rounded-sm border border-gray-200 dark:border-gray-700/60 shadow-md overflow-hidden">
          <div className="p-6 text-center">
            <div className="bg-gray-50/80 dark:bg-gray-700/30 p-6 round-sm border border-gray-200/70 dark:border-gray-600/40 inline-block">
              ...
              <button
                onClick={() => navigate("/study-groups")}
                className="px-4 py-2 bg-primary hover:bg-primary/90 dark:bg-primary/90 dark:hover:bg-primary text-white round-sm shadow transition-colors"
              >
                Back to Study Groups
              </button>
            </div>
        ...
        <div className="px-4 sm:px-6 py-5 border-b border-gray-200 dark:border-gray-700/40 bg-gray-50/80 dark:bg-gray-700/30">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div className="flex items-center">
              <button
                onClick={() => navigate("/study-groups")}
                className="mr-3 p-2 text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/30 round-sm transition-colors"
              >
                <ArrowLeft size={18} />
              </button>
              <div>
              ...
              {isCreator && (
                <>
                  <button
                    ...
                    className="px-3 py-2 bg-secondary hover:bg-secondary/90 dark:bg-secondary/90 dark:hover:bg-secondary text-white round-sm flex items-center text-sm font-medium shadow transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-primary hover:bg-primary/90 dark:bg-primary/90 dark:hover:bg-primary text-white round-sm flex items-center text-sm font-medium shadow transition-colors"
                  >
        ...
        <div className="p-4 sm:p-6">
          ...
          {getEventDetails() &&
            new Date(getEventDetails().scheduledDate) < new Date() && (
              <div className="mb-6 p-4 rounded-sm bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800/30 text-amber-800 dark:text-amber-300 flex items-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="md:col-span-2">
              <div className="bg-white/95 dark:bg-gray-800/90 rounded-sm border border-gray-200 dark:border-gray-700/40 shadow-sm">
                {activeTab === "chat" && (
                  <GroupChat
                    groupId={id}
                    currentUser={user}
