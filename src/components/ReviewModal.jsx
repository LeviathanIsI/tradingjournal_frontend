...
const ReviewModal = ({ isOpen, onClose, trade, review, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-white/95 dark:bg-gray-800/90 rounded-sm border border-gray-200 dark:border-gray-700/40 w-full max-w-3xl max-h-[90vh] overflow-y-auto shadow-lg">
        <div className="flex justify-between items-center p-5 border-b border-gray-200 dark:border-gray-700/40">
          ...
          <button
            onClick={onClose}
            className="p-2 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700/30 round-sm transition-colors"
          >
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="p-5">
          <div className="mb-5 p-4 bg-gray-50/80 dark:bg-gray-700/30 round-sm border border-gray-200/70 dark:border-gray-600/30">
            {renderTradeSummary()}
          </div>
